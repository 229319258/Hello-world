package com.deepexi.s.product.service.impl;

import com.alibaba.csp.sentinel.annotation.SentinelResource;
import com.alibaba.dubbo.config.annotation.Service;
import com.alibaba.dubbo.rpc.RpcContext;
import com.deepexi.s.product.enums.ResultEnum;
import com.deepexi.s.product.service.ProductService;
import com.deepexi.s.product.domain.eo.Product;
import com.deepexi.s.product.extension.AppRuntimeEnv;
import com.deepexi.s.product.mapper.ProductMapper;
...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public Integer updateById(String id, Product product) {
        Product productOld = productMapper.selectById(id);
        BeanUtils.copyProperties(productOld, product, "name", "price");
