package com.deepexi.consumer.aop;

import com.alibaba.fastjson.JSON;
import com.deepexi.consumer.extension.AppRuntimeEnv;
...
public class LogAspect {
    ...
    @Pointcut("execution (* com.deepexi.consumer.controller..*.*(..))")
    public void controllerLogAop() {
    }

    @Pointcut("execution (* com.deepexi.consumer.service..*.*(..))")
